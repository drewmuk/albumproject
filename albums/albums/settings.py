...
SECRET_KEY = 'django-insecure-=1_&yj63je^9vwaj$^)c68+eb5ap^4se1+cki8&cv_o2+^t4tw'
...
OAUTH2_PROVIDER = {
    'SCOPES': {'user-read-library user-library-modify'},  # Set the desired scopes for your app
}
